...
namespace eDentalClinicWebAPI.Migrations
{
    ...
    [Migration("20210218100754_Seedtest")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eDentalClinicWebAPI.Database.DentistBranch", b =>
                {
                    b.Property<int>("DentistBranchID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("DentistBranchID");

                    b.HasIndex("BranchID");

                    b.HasIndex("DentistID");

                    b.ToTable("DentistBranches");
                });
            ...
            modelBuilder.Entity("eDentalClinicWebAPI.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "iFtP7lw3d/kIyRwu/r3ZNY7CkYM=",
                            PasswordSalt = "l4X26fhx/gWyFhGCNSpITQ==",
                            Phone = "062440876",
                            Username = "William"
                        });
                });
